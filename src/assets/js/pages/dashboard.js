...
altair_dashboard = {
    init: function () {
        ...
        // custom charts
        altair_dashboard.custom_charts();
        // large graph
    ...
    custom_charts: function () {
        var mGraph_custom = '#mGraph_custom';

        if ($(mGraph_custom).length) {
            ...
            function buildGraph_sale() {
                ...
                if($thisEl_height == 0) {
                    var $thisEl_height = $(mGraph_custom).height();
                }

                var $thisEl_width = $(mGraph_custom).width();
            ...
            $("#mGraph_custom").on('display.uk.check', function(){
                buildGraph_sale();
            });
